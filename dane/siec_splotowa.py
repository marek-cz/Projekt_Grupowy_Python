...
if decyzja == 't':
    ...
    data_Socik = np.load('data_Socik_SPLOTOWA.npy')
    etykiety_liczby_Socik = np.load('labels_Socik_SPLOTOWA.npy')
    data_Marek = np.load('data_Marek_SPLOTOWA.npy')
    etykiety_liczby_Marek = np.load('labels_Marek_SPLOTOWA.npy')
