...
#kursor_bazy_danych.execute("create table probki (id integer primary key, a_x text, a_y text, a_z text, g_x text, g_y text, g_z text, czas datetime )")
