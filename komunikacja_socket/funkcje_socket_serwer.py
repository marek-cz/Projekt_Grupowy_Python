...
def klasyfikacja_odchylenie_std(probka_danych):
    ...
    if (odchylenia_std_osi[0] >= PROGI_ODCHYLENIE_STD['Bieganie']['akc_x']) and (odchylenia_std_osi[2] >= PROGI_ODCHYLENIE_STD['Bieganie']['akc_z']) and (odchylenia_std_osi[4] >= PROGI_ODCHYLENIE_STD['Bieganie']['gyr_y']):
        return 2 # indeks biegania
    elif (odchylenia_std_osi[0] >= PROGI_ODCHYLENIE_STD['Trucht']['akc_x']) and (odchylenia_std_osi[2] >= PROGI_ODCHYLENIE_STD['Trucht']['akc_z']) and (odchylenia_std_osi[4] >= PROGI_ODCHYLENIE_STD['Trucht']['gyr_y']):
        return 1 # indeks truchtu
    elif (odchylenia_std_osi[0] >= PROGI_ODCHYLENIE_STD['Marsz']['akc_x']) and (odchylenia_std_osi[2] >= PROGI_ODCHYLENIE_STD['Marsz']['akc_z']) and (odchylenia_std_osi[4] >= PROGI_ODCHYLENIE_STD['Marsz']['gyr_y']):
        return 1 # indeks marszu
    else :
        return 3 # indeks stania


def lista_stringow_na_probke(lista_danych):
